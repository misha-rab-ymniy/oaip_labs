...
namespace alejlib {
    ...
    private:
        ...
        static int InorderPrint(TreeNode *root)
        {
            if (root == nullptr) {
               return int();
            }
        ...
        static int PreorderPrint(TreeNode *root)
        {
            if (root == nullptr) {
               return int();
            }
        ...
        static int PostorderPrint(TreeNode *root)
        {
            if (root == nullptr) {
               return 1;
            }
    ...
    public:
        ...
        public:
            ...
            friend void map<T>::erase(const iterator& it);
        };
